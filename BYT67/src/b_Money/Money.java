...
public class Money implements Comparable {
	...
	public Double universalValue() {
		return getCurrency().universalValue(amount);
	}
	...
	public Money add(Money other) {
		Integer newAmount = amount + this.getCurrency().valueInThisCurrency(other.amount, other.getCurrency());
	 ...
	 */
	public Money negate() {
		return new Money(this.amount*-1,this.getCurrency());
	}
